...
const AsianFusion = () => {
  ...
  const websiteUrl = "https://asianfusion.nz";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="animate-fade-in-up">
              <div className="flex items-center mb-3">
                ...
                <span className="text-sm font-medium text-primary uppercase tracking-wide">Bethlehem</span>
              </div>
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center"><Phone size={18} className="mr-3 text-primary" /><a href="tel:0224026481" className="hover:text-primary transition-colors">022 402 6481</a></div>
                <div className="flex items-center"><Mail size={18} className="mr-3 text-primary" /><a href="mailto:info@asianfusion.nz" className="hover:text-primary transition-colors">info@asianfusion.nz</a></div>
              </div>

              <div className="flex flex-wrap gap-3">
                <a href={websiteUrl} target="_blank" rel="noopener noreferrer" className="btn-primary inline-flex items-center">
                  Go to Asian Fusion <ExternalLink size={18} className="ml-2" />
                </a>
